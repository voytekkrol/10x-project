...
describe("ProposalCard", () => {
  ...
  it("should render in pending state", () => {
    render(<ProposalCard proposal={defaultProposal} index={0} {...handlers} />);
  ...
  it("should render in accepted state", () => {
    render(<ProposalCard proposal={{ ...defaultProposal, status: "accepted" }} index={0} {...handlers} />);
  ...
  it("should not render rejected proposals", () => {
    const { container } = render(
      <ProposalCard proposal={{ ...defaultProposal, status: "rejected" }} index={0} {...handlers} />
    );
